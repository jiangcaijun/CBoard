...
var dataServer = function (e) {
    var cityId=$('#city_name').val();
    ajaxThenParams('117a5bde-9952-11e8-9790-496b3deef604',"{city_id:'"+ cityId +"'}").then((res) => {
        renderMap(res)
    })
}
...
function renderMap(data) {
    ...
    for (var key in areas1) {
        ...
        var clor = getColor(polygon_window_conf1.cluster_id);
        ...
        (function () {
            ...
            //     // polygon.z.strokeColor = 'red';
            //     // e.target.z.strokeColor = 'red'
            ...
            var content = "<p style='text-align: center;padding-left: 3px;line-height: 12px'>"+polygon_window_conf1.cluster_id + '</p>';
